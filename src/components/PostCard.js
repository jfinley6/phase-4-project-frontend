  ...
  return (
    <div className="col-12 col-sm-8 col-md-6 col-lg-4 mb-3">
      <div className="card d-flex shadow">
        ...
        <div style={{textAlign: "center"}}>{post.comments === undefined ? null : post.comments.length} comments </div>
        <div
          style={{ textAlign: "center" }}
          className="card-footer text-muted d-flex justify-content-center bg-transparent border-top-0"
        >
